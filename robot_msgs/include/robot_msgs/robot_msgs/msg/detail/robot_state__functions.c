...
robot_msgs__msg__RobotState__init(robot_msgs__msg__RobotState * msg)
{
  ...
  // motor_feedback
  if (!node_control_msgs__msg__MotorCommandFeedback__init(&msg->motor_feedback)) {
    robot_msgs__msg__RobotState__fini(msg);
    return false;
  }
  return true;
...
robot_msgs__msg__RobotState__fini(robot_msgs__msg__RobotState * msg)
{
  ...
  // motor_feedback
  node_control_msgs__msg__MotorCommandFeedback__fini(&msg->motor_feedback);
}
...
robot_msgs__msg__RobotState__are_equal(const robot_msgs__msg__RobotState * lhs, const robot_msgs__msg__RobotState * rhs)
{
  ...
  // motor_feedback
  if (!node_control_msgs__msg__MotorCommandFeedback__are_equal(
      &(lhs->motor_feedback), &(rhs->motor_feedback)))
  {
    return false;
  }
  return true;
  ...
  robot_msgs__msg__RobotState * output)
{
  ...
  if (!node_control_msgs__msg__MotorCommandFeedback__copy(
      &(input->motor_feedback), &(output->motor_feedback)))
  {
    return false;
  }
  return true;
