...
bool robot_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // motor_feedback
    PyObject * field = PyObject_GetAttrString(_pymsg, "motor_feedback");
    if (!field) {
      return false;
    }
    if (!node_control_msgs__msg__motor_command_feedback__convert_from_py(field, &ros_message->motor_feedback)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * robot_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // motor_feedback
    PyObject * field = NULL;
    field = node_control_msgs__msg__motor_command_feedback__convert_to_py(&ros_message->motor_feedback);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "motor_feedback", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
