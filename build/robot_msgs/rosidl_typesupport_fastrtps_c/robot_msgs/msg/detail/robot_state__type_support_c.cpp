...
#include "node_control_msgs/msg/detail/motor_command_feedback__functions.h"  // motor_feedback
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motor_feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, node_control_msgs, msg, MotorCommandFeedback
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->motor_feedback, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motor_feedback
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->motor_feedback))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_node_control_msgs__msg__MotorCommandFeedback(
    &(ros_message->motor_feedback), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // member: motor_feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_node_control_msgs__msg__MotorCommandFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, motor_feedback) +
      last_member_size
      ) == ret_val;
  }
