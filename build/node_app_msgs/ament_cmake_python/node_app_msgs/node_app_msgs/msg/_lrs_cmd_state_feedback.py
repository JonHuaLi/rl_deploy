...
class Metaclass_LrsCmdStateFeedback(type):
    """Metaclass of message 'LrsCmdStateFeedback'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_app_msgs.msg.LrsCmdStateFeedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lrs_cmd_state_feedback
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lrs_cmd_state_feedback
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lrs_cmd_state_feedback
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lrs_cmd_state_feedback
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lrs_cmd_state_feedback
    ...
    def STATE_DISABLED(self):
        ...
        return Metaclass_LrsCmdStateFeedback.__constants['STATE_DISABLED']

    @property
    def STATE_DAMPING(self):
        """Message constant 'STATE_DAMPING'."""
        return Metaclass_LrsCmdStateFeedback.__constants['STATE_DAMPING']

    @property
    def STATE_READY(self):
        """Message constant 'STATE_READY'."""
        return Metaclass_LrsCmdStateFeedback.__constants['STATE_READY']

    @property
    def STATE_RUNNING(self):
        """Message constant 'STATE_RUNNING'."""
        return Metaclass_LrsCmdStateFeedback.__constants['STATE_RUNNING']

    @property
    def MODE_DEFAULT(self):
        """Message constant 'MODE_DEFAULT'."""
        return Metaclass_LrsCmdStateFeedback.__constants['MODE_DEFAULT']

    @property
    def MODE_DANCE(self):
        """Message constant 'MODE_DANCE'."""
        return Metaclass_LrsCmdStateFeedback.__constants['MODE_DANCE']


class LrsCmdStateFeedback(metaclass=Metaclass_LrsCmdStateFeedback):
    """
    Message class 'LrsCmdStateFeedback'.
