...
static const _LrsCmdState_type_support_symbol_names_t _LrsCmdState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_app_msgs, msg, LrsCmdState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_app_msgs, msg, LrsCmdState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, node_app_msgs, msg, LrsCmdState)() {
  return &::node_app_msgs::msg::rosidl_typesupport_c::LrsCmdState_message_type_support_handle;
}
