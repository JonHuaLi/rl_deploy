...
#include "node_control_msgs/msg/detail/motor_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_control_msgs::msg::MotorConfig & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_control_msgs::msg::MotorConfig & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_control_msgs
max_serialized_size_MotorConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs::msg::MotorConfig;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_control_msgs::msg::MotorConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_control_msgs::msg::MotorConfig *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorConfig__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const node_control_msgs::msg::MotorConfig *>(
...
static size_t _MotorConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorConfig(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorConfig__callbacks = {
...
static rosidl_message_type_support_t _MotorConfig__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorConfig__callbacks,
...
{
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorConfig__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_control_msgs, msg, MotorConfig)() {
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorConfig__handle;
}
