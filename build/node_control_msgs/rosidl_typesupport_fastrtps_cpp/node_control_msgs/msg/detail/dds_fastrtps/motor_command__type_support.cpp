...
#include "node_control_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_control_msgs::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_control_msgs::msg::MotorCommand & ros_message)
{
  // Member: kp
  cdr >> ros_message.kp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_control_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_control_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_control_msgs, msg, MotorCommand)() {
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
