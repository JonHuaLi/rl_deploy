...
#include "node_control_msgs/msg/detail/motor_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const node_control_msgs::msg::MotorCommand &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const node_control_msgs::msg::MotorControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_control_msgs::msg::MotorControl & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        node_control_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCommand(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs::msg::MotorControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_control_msgs::msg::MotorControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_control_msgs::msg::MotorControl *>(
    untyped_ros_message);
...
{
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_control_msgs, msg, MotorControl)() {
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorControl__handle;
}
