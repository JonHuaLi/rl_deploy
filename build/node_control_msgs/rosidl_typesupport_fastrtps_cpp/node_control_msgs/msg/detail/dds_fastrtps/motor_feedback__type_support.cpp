...
#include "node_control_msgs/msg/detail/motor_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_control_msgs::msg::MotorFeedback & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_control_msgs::msg::MotorFeedback & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs::msg::MotorFeedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_control_msgs::msg::MotorFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_control_msgs::msg::MotorFeedback *>(
    untyped_ros_message);
...
{
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorFeedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_control_msgs, msg, MotorFeedback)() {
  return &node_control_msgs::msg::typesupport_fastrtps_cpp::_MotorFeedback__handle;
}
