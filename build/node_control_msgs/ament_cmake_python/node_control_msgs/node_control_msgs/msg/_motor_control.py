    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_control_msgs.msg.MotorControl')
            logger.debug(
...
class MotorControl(metaclass=Metaclass_MotorControl):
    ...
    _fields_and_field_types = {
        ...
        'seq_num': 'uint32',
        'cmd': 'sequence<node_control_msgs/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['node_control_msgs', 'msg'], 'MotorCommand')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'cmd' field must be a set or sequence and each value of type 'MotorCommand'"
        self._cmd = value
