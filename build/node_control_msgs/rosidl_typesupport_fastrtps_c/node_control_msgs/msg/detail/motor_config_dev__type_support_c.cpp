...
#include "node_control_msgs/msg/detail/motor_config_dev__rosidl_typesupport_fastrtps_c.h"
...
using _MotorConfigDev__ros_msg_type = node_control_msgs__msg__MotorConfigDev;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorConfigDev__ros_msg_type * ros_message = static_cast<const _MotorConfigDev__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _MotorConfigDev__ros_msg_type * ros_message = static_cast<_MotorConfigDev__ros_msg_type *>(untyped_ros_message);
  // Field name: parameter_id
  {
    cdr >> ros_message->parameter_id;
  }
...
static uint32_t _MotorConfigDev__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_control_msgs__msg__MotorConfigDev(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs__msg__MotorConfigDev;
    is_plain =
      (
...
static size_t _MotorConfigDev__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_control_msgs__msg__MotorConfigDev(
...
static message_type_support_callbacks_t __callbacks_MotorConfigDev = {
...
static rosidl_message_type_support_t _MotorConfigDev__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorConfigDev,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_control_msgs, msg, MotorConfigDev)() {
  return &_MotorConfigDev__type_support;
}
