...
#include "node_control_msgs/msg/detail/motor_control__rosidl_typesupport_fastrtps_c.h"
...
#include "node_control_msgs/msg/detail/motor_command__functions.h"  // cmd
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_node_control_msgs__msg__MotorCommand(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_node_control_msgs__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_control_msgs, msg, MotorCommand)();
...
using _MotorControl__ros_msg_type = node_control_msgs__msg__MotorControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cmd
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, node_control_msgs, msg, MotorCommand
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cmd
  {
    ...
    if (ros_message->cmd.data) {
      node_control_msgs__msg__MotorCommand__Sequence__fini(&ros_message->cmd);
    }
...
size_t get_serialized_size_node_control_msgs__msg__MotorControl(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorControl__ros_msg_type * ros_message = static_cast<const _MotorControl__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_node_control_msgs__msg__MotorCommand(
...
static uint32_t _MotorControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_control_msgs__msg__MotorControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_control_msgs
size_t max_serialized_size_node_control_msgs__msg__MotorControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_node_control_msgs__msg__MotorCommand(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs__msg__MotorControl;
    is_plain =
      (
...
static size_t _MotorControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_control_msgs__msg__MotorControl(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_control_msgs, msg, MotorControl)() {
