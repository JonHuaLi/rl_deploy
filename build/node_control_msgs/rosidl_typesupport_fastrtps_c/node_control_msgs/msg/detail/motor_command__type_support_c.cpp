...
#include "node_control_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommand__ros_msg_type = node_control_msgs__msg__MotorCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: position_des
  {
    cdr << ros_message->position_des;
  }

  // Field name: omega_des
  {
    cdr << ros_message->omega_des;
  }

  // Field name: torque_des
  {
    cdr << ros_message->torque_des;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name position_des
  {
    size_t item_size = sizeof(ros_message->position_des);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name omega_des
  {
    size_t item_size = sizeof(ros_message->omega_des);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name torque_des
  {
    size_t item_size = sizeof(ros_message->torque_des);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name reserved
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_control_msgs__msg__MotorCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_control_msgs__msg__MotorCommand;
    is_plain =
      (
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_control_msgs__msg__MotorCommand(
