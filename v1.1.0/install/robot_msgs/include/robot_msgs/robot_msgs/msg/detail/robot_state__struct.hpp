...
struct RobotState_
{
  ...
  Type & set__motor_feedback(
    const node_control_msgs::msg::MotorCommandFeedback_<ContainerAllocator> & _arg)
  {
    this->motor_feedback = _arg;
    return *this;
  }
  ...
  bool operator==(const RobotState_ & other) const
  {
    ...
    if (this->motor_feedback != other.motor_feedback) {
      return false;
    }
    return true;
  }
