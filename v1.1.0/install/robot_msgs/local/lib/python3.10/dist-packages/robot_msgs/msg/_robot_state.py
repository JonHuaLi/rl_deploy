...
class Metaclass_RobotState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from node_control_msgs.msg import MotorCommandFeedback
            if MotorCommandFeedback.__class__._TYPE_SUPPORT is None:
                MotorCommandFeedback.__class__.__import_type_support__()
...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types = {
        ...
        'imu': 'sensor_msgs/Imu',
        'motor_feedback': 'node_control_msgs/MotorCommandFeedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'Imu'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['node_control_msgs', 'msg'], 'MotorCommandFeedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from node_control_msgs.msg import MotorCommandFeedback
        self.motor_feedback = kwargs.get('motor_feedback', MotorCommandFeedback())
    ...
    def __eq__(self, other):
        ...
        if self.imu != other.imu:
            return False
        if self.motor_feedback != other.motor_feedback:
            return False
        return True
    ...
    def motor_feedback(self):
        """Message field 'motor_feedback'."""
        return self._motor_feedback

    @motor_feedback.setter
    def motor_feedback(self, value):
        if __debug__:
            from node_control_msgs.msg import MotorCommandFeedback
            assert \
                isinstance(value, MotorCommandFeedback), \
                "The 'motor_feedback' field must be a sub message of type 'MotorCommandFeedback'"
        self._motor_feedback = value
