    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_control_msgs.msg.MotorInfo')
            logger.debug(
            ...
            from node_control_msgs.msg import MotorInfoValue
            if MotorInfoValue.__class__._TYPE_SUPPORT is None:
                MotorInfoValue.__class__.__import_type_support__()
...
class MotorInfo(metaclass=Metaclass_MotorInfo):
    ...
    _fields_and_field_types = {
        ...
        'info': 'sequence<node_control_msgs/MotorInfoValue>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['node_control_msgs', 'msg'], 'MotorInfoValue')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, MotorInfoValue) for v in value) and
                 True), \
                "The 'info' field must be a set or sequence and each value of type 'MotorInfoValue'"
        self._info = value
