...
bool node_driver_msgs__msg__sensormsgstate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_driver_msgs.msg._sensormsgstate.Sensormsgstate", full_classname_dest, 51) == 0);
  }
  node_driver_msgs__msg__Sensormsgstate * ros_message = _ros_message;
  {  // header
  ...
  {  // sensor_state
    ...
    assert(PyLong_Check(field));
    ros_message->sensor_state = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // error_message
...
{
  /* NOTE(esteve): Call constructor of Sensormsgstate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_driver_msgs.msg._sensormsgstate");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Sensormsgstate");
